...
class _OffsideApi implements OffsideApi {
  _OffsideApi(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<List<MatchDto>> matches() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<MatchDto>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/matches',
  ...
  Future<MatchDto> matchById(int id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MatchDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/matches/${id}',
  ...
  Future<List<BetDto>> bets() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<BetDto>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/bets',
  ...
  @override
  Future<IdDto> uploadImage(ImageDto image) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(image.toMap());
    final _options = _setStreamType<IdDto>(
      Options(method: 'PUT', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<List<PrivateTableDto>> privateTables() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<PrivateTableDto>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/private-tables',
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<PrivateTableDto> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
  ...
  Future<PrivateTableDto> privateTableById(int id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PrivateTableDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/private-tables/${id}',
